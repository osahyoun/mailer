...
database_name = case Padrino.env
  when :development then 'mailer_prototype_development'
  when :production  then 'mailer_prototype_production'
  when :test        then 'mailer_prototype_test'
end
...
#     sessions:
#       default:
#         database: mailer_prototype_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: mailer_prototype_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: mailer_prototype_test
#         hosts:
#           - localhost:27017
#
#
